...
const std::string typical_angles[] = { "90", "0", "180" }; // indices match to #defs for CENTER/MIN/MAX above
const std::string typical_pulse_widths[] = { "1500", "700", "2300" }; // indices match to #defs for CENTER/MIN/MAX above
